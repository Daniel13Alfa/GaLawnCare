...
function TopMenu() {
  ...
  const navLinkClassL = ({ isActive }) =>
  `relative block px-4 py-2 text-lg transition-colors duration-300
   ${isActive 
     ? `text-green-700 font-semibold 
        after:content-[''] after:absolute after:bottom-2 after:left-1/2 after:-translate-x-1/2
        after:w-12 after:h-[2px] after:bg-green-700
        after:scale-x-100 after:origin-left after:transition-transform after:duration-800` 
     : `text-gray-700 hover:text-green-700 
        after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2
        after:w-8 after:h-[2px] after:bg-green-700
        after:scale-x-0 after:origin-left after:transition-transform after:duration-800`}`;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20 py-3">
            ...
            <nav className="hidden md:flex ">
              <NavLink to="/" className={navLinkClassL}>Home</NavLink>
              <NavLink to="/about" className={navLinkClassL}>About Us</NavLink>
              <NavLink to="/services" className={navLinkClassL}>Services</NavLink>
              <NavLink to="/contactUs" className={navLinkClassL}>Contact</NavLink>
            </nav>
